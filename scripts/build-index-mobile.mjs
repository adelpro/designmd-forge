...
if (!repoPath || !existsSync(repoPath)) {
  console.error("Usage: node scripts/build-index-mobile.mjs <path-to-cloned-awesome-mobile-design-md-repo>");
  process.exit(1);
}
...
const files = readdirSync(designMdDir).filter((f) => extname(f).toLowerCase() === ".md" && f !== "README.md");
const index = [];
...
writeFileSync(
  ...
  JSON.stringify({ source: "https://github.com/TrustOtc/awesome-mobile-design-md", license: "MIT", designs: index }, null, 2),
  "utf-8"
);
